// src/app/(authenticated)/config/page.tsx
      ...
      <div className={formStyles.section}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={formStyles.form}>
          <div className="space-y-2">
            <label className={formStyles.label}>CNPJ</label>
            <input
              {...register('cnpj')}
              type="text"
            ...
            />
            {errors.cnpj && (
              <p className={formStyles.error}>{errors.cnpj.message}</p>
            )}
          </div>

          <div className="space-y-2">
            <label className={formStyles.label}>Token VMHub</label>
            <input
              {...register('vmhubToken')}
              type="password"
              className={formStyles.input}
            ...
            />
            {errors.vmhubToken && (
              <p className={formStyles.error}>{errors.vmhubToken.message}</p>
            )}
          </div>

          <div className="space-y-2">
            <label className={formStyles.label}>Token WhatsApp</label>
            <input
            ...
            {errors.whatsappToken && (
              <p className={formStyles.error}>{errors.whatsappToken.message}</p>
            )}
          </div>
